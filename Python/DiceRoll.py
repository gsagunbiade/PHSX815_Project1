# -*- coding: utf-8 -*-
"""
Created on Sat Feb  4 13:34:56 2023
...
if __name__ == "__main__":
    ...
    if '-h' in sys.argv or '--help' in sys.argv:
        print ("Usage: %s [-seed number] [-Ndice number] [-Nexp number] [-prob1 number] [-prob2 number] [-prob3 number] [-prob4 number] [-prob5 number] [-prob6 number] [-prob7 number]" % sys.argv[0])
        print
        sys.exit(1)
    ...
    if doOutputFile:
        ...
        for e in range(0,Nexp):
            for t in range(0,Ndice):
                outfile.write(str(random.Categorical(prob1,prob2,prob3,prob4,prob5,prob6,prob7))+" ")
            outfile.write(" \n")
        outfile.close()
    else:
        for e in range(0,Nexp):
            for t in range(0,Ndice):
                print(random.Categorical(prob1,prob2,prob3,prob4,prob5,prob6,prob7), end=' ')
            print(" ")