# -*- coding: utf-8 -*-
"""
Created on Sat Feb  4 13:15:10 2023
...
class Random:
    ...
    def Categorical(self, p1=0.166667,p2=0.166667, p3=0.166667, p4=0.166667, p5=0.166667,  p6=0.166667, p7=0.166667):
        if p1 < 0. or p1 > 1.:
            return 1
        if p2 < 0. or p2 > 1.:
            return 2            
        ...
        if p1 + p2 + p3 + p4  < R < p1 + p2 + p3 + p4 + p5:
            return 5
        if p1 + p2 +p3 < R < p1 + p2 + p3 +  p4 +p5 + p6:
            return 6
        if p1 + p2 + p3 + p4  < R < p1 + p2 + p3 + p4 + p5 + p6 + p7:
            return 7
        else:
            return 8
